...
public class StrengthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subpage_strength);
        final int[] flag = {0};

        //button_switch监听
        Button mbtn_switch = findViewById(R.id.btn_open6);
        ...
        mbtn_back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //跳转到主界面
                Intent intent =new Intent(StrengthActivity.this,maininterface.class);
